...
1. Refer to previous document for understanding the Django app (refer to this doc [[](054containerize)])
...
12. refer to [](054containerize) containerize section to build a new container image of the django app.
