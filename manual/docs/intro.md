...
- [CesiumJS](https://cesium.com/platform/cesiumjs/) - visualizing 3D models in a virtual 3D globe

Optional installations
- [TimescaleDB](https://www.tigerdata.com/timescaledb) - extension of PostgreSQL that can handle time-series data.
