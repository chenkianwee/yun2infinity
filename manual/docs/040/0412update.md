...
1. Backup the database before doing any update. Follow the instruction here: [](../040/0411maintain).
...
2. Pull the latest image from Docker Hub and run a new container with the new image.
    ...
    ```
3. Run the remove masa3db script as shown here [](../020/020installation).
